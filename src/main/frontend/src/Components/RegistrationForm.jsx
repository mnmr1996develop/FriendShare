        ...
        <div className="input-holder">
          <div className="input-box-half">
            <input
              ...
              type="text"
              onChange={(e) => {
                setFirstName(e.target.value.trim().replace(/[^a-zA-Z-]/gi, ""));
              }}
            ...
            <input
              ...
              type="text"
              onChange={(e) => {
                setLastName(e.target.value.trim().replace(/[^a-zA-Z-]/gi, ""));
              }}
          ...
          <div className="input-box">
            <input
              ...
              placeholder="Email"
            />
            {emailTaken && <h6 style={{ color: "red" }}>Email Taken</h6>}
          </div>
          ...
          <div className="input-box">
            <input
              ...
              type="text"
              onChange={(e) =>
                setUsername(e.target.value.trim().replace(/[^\w_-]/gi, ""))
              }
              placeholder="Username"
            />
            {userTaken && <h6 style={{ color: "red" }}>Username Taken</h6>}
          </div>
